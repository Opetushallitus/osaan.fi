...
angular.module('osaan.tekstit', ['pascalprecht.translate'])
  .constant('tekstit', {
      ...
      'etusivu.teksti': 'Voit arvioida osaamistasi valitsemassasi ammatillisessa perustutkinnossa, ammattitutkinnossa tai erikoisammattitutkinnossa.\n\n Arviointi tehdään tutkinnoissa edellytettyjen ammattitaitovaatimusten perusteella, jotka on laadittu yhteistyössä työelämän kanssa. Tutkinnon tai tutkinnon osan tai osien suorittamisessa huomioidaan aiempi osaamisesi, joka voi olla hankittu esimerkiksi työssä, opinnoissa tai muussa toiminnassa. Kun hakeudut suorittamaan tutkintoa, oppilaitos selvittää aiemman osaamisesi ja sinulle laaditaan henkilökohtainen osaamisen kehittämissuunnitelma. Jos olet kiinnostunut suorittamaan tutkinnon, ole yhteydessä koulutuksen järjestäjiin, jotka näet linkkien kautta.',
      ...
      'footer.ota_yhteytta_email': 'ammatillinenkoulutus@oph.fi',
    ...
    sv: {
      ...
      'etusivu.teksti': 'Du kan bedöma ditt eget kunnande inom en vald yrkesinriktad grundexamen, yrkesexamen eller specialyrkesexamen.\n\n Bedömningen görs utgående från de krav på yrkesskicklighet som förutsätts för examen eller för en eller flera delar av en examen och som sammanställts i samarbete med arbetslivet. Då man avlägger en examen beaktas tidigare kunnande som t.ex. förvärvats i arbete, studier eller i annan verksamhet. När du ämnar avlägga en examen, utreder läroanstalten ditt tidigare kunnande och en personlig utvecklingsplan för kunnande utarbetas. Ta kontakt med anordnaren av den utbildningen som du ser via länken om du är intresserad av att avlägga en examen.',
      ...
      'footer.ota_yhteytta': 'Respons om andvändningen av Jagkan.fi kan du skicka per e-post till adressen',
      'footer.ota_yhteytta_email': 'ammatillinenkoulutus@oph.fi',
