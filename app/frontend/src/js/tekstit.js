...
angular.module('osaan.tekstit', ['pascalprecht.translate'])
  .constant('tekstit', {
    ...
    sv: {
      ...
      'etusivu.teksti': 'Du kan bedöma och utvärdera ditt eget kunnande inom en vald yrkesinriktad grundexamen, yrkesexamen eller specialyrkesexamen. Bedömningen görs utgående från de krav på yrkesskicklighet som förutsätts för examen och som sammanställts i samarbete med arbetslivet. Då man avlägger en examen beaktas tidigare kunnande som t.ex. förvärvats i arbete, studier eller i annan verksamhet. När du är i beråd att avlägga en examen, utreder läroanstalten ditt tidigare kunnande. Ta kontakt med anordnaren av den fristående examen eller utbildningen som du ser via länken om du är intresserad av att avlägga en examen.',
      ...
      'tutkinto.otsikko': 'Börja genom att söka en examen',
