...
angular.module('osaan.tekstit', ['pascalprecht.translate'])
  .constant('tekstit', {
      ...
      'raportti.vapaateksti_otsikko': 'Vapaata tekstiä, joka tulostuu tulosteelle ennen varsinaista raporttia:',
      'raportti.vapaateksti_nayta': 'Näytä vapaatekstikenttä',      
      ...
      'tutkinto.vanha_osaanfi': 'Osaa tutkinnoista ei ole vielä siirretty uuteen palveluun. Jos et löydä hakemaasi tutkintoa tai sen arviointikohteita, tarkista löytyykö se vanhasta Osaan.fi –palvelusta.',
    ...
    sv: {
      ...
      'raportti.vapaateksti_otsikko': 'Vapaata tekstiä, joka tulostuu tulosteelle ennen varsinaista raporttia: (sv)',
      'raportti.vapaateksti_nayta': 'Näytä vapaatekstikenttä (sv)',
      ...
      'tutkinto.vanha_osaanfi': 'Alla examina har ännu inte överförts till den nya tjänsten. Om du inte hittar den examen eller de bedömningskriterier du söker, kontrollera om de finns i den gamla Jagkan.fi tjänsten.',
