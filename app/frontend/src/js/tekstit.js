...
angular.module('osaan.tekstit', ['pascalprecht.translate'])
  .constant('tekstit', {
    ...
    sv: {
      ...
      'etusivu.teksti': 'Du kan bedöma och utvärdera ditt eget kunnande inom en vald yrkesinriktad grundexamen, yrkesexamen eller specialyrkesexamen.\n\nBedömningen görs utgående från de krav på yrkesskicklighet som förutsätts för examen och som sammanställts i samarbete med arbetslivet. Då man avlägger en examen beaktas tidigare kunnande som t.ex. förvärvats i arbete, studier eller i annan verksamhet. När du är i beråd att avlägga en examen, utreder läroanstalten ditt tidigare kunnande. Ta kontakt med anordnaren av den fristående examen eller utbildningen som du ser via länken om du är intresserad av att avlägga en examen.\n\nEn fristående examen är ett särskilt för vuxna planerat sätt att avlägga examen. En yrkesinriktad grundexamen är en utbildning planerad särskilt för unga.',
      ...
      'tallennus.kopioi_ohje': 'Välj länken och kopiera den till klippbordet genom att trycka:',
      'tallennus.laheta_sahkopostilla': 'Eller skicka länken per e-post.',
      'tallennus.otsikko': 'Bedömningen har lagrats',
      'tallennus.sulje': 'Stäng',
      'tallennus.teksti': 'Bedömningen och dina svar har nu sparats. Du kan återvända till bedömningen via länken nedan och se, ändra eller komplettera den. Välj länken och kopiera den till klippbordet genom ctrl+c.\n\nSpara länken åt dig själv. Du kan återvända till bedömningen genom att kopiera länken till adressfältet i din webbläsare. Om du ändrar eller kompletterar dina svar, skapar varje ny lagring en ny länk. Också dina tidigare bedömningar finns kvar via de länkar som du fått tidigare. Bedömningarna som lagrats är anonyma och sparas i tre år fr.o.m. lagringsögonblicket. Därefter raderas svaren ur systemet.\n\nOm du t.ex. har kommit överens om att skicka dina svar till en läroanstalt eller läroavtalsbyrå, kan du skicka denna länk. Öppna din e-post om du har tillgång till en sådan.',
